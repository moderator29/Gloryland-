      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Your Halcyon invite. Earn from every deposit.
          </p>
        </div>
      </div>
      <div className="mt-4 flex items-center gap-2 rounded-2xl border border-border/60 bg-black/40 px-3 py-2.5">
        <span className="chip-navy shrink-0 !px-2.5 !py-1 text-[10px] uppercase tracking-widest">
          Code
        </span>
        <code className="flex-1 truncate font-mono text-base font-semibold tracking-[0.2em] text-gradient-gold">
          {code}
        </code>
        <button
          onClick={copy}

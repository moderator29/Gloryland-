...
export const PACKAGES = [
  ...
  { name: "Gold Plan", price: 10000, daily: 2200, spots: 20, taken: 20 },
  { name: "Legendary Plan", price: 20000, daily: 5000, spots: 20, taken: 1 },
  { name: "Immortal Plan", price: 40000, daily: 9000, spots: 20, taken: 19 },
] as const;
